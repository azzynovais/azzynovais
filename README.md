...
Além do código, sou um entusiasta de Linux, acreditando que mentes saudáveis produzem sistemas melhores.

---

## 🏗️ Arquitetura de Software & Desenvolvimento Web, IoT
Minha abordagem foca em **Clean Architecture**, IoT e **Event-Driven Design**.

* **Linguagens:** Python, Javascript, HTML/CSS/JS, pouco de C#/Vala
* **Frontend:** React, Next.js
* **Backend:** Node.js, Ruby On Rails
* **Arquitetura:** Design Patterns, Escalabilidade e Performance.
...
## 🧠 Saúde Mental & Bem-estar no Mundo da Technologia
